...
class HaveCakeProblem(Problem):
    ...
    def get_actions(self):
        ...
        eat_action = Action(expr("Eat(Cake)"),
                            ...
                            [effect_add, effect_rem])#having an action object 
        precond_pos = []
...
if __name__ == '__main__':
    p = have_cake()#a function that returns a HaveCakeProblem object initialized with object 'initial' from Fluent class get_init and get_goal 
	#p is now a HaveCakeProblem object with attributes: self.state_map=initial.pos + initial.neg and all actions in action_list
