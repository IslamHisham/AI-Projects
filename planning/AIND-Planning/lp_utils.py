...
class FluentState():#the objects will hold the initial states of the problem (pre-conditions)
    ...
    def sentence(self):
        return expr(conjunctive_sentence(self.pos, self.neg))#conjunctive takes the positve list of expressions and and them with the '~' "not operator" of neg_list of expressions e.g. "At(C1, SFO) ∧ ~At(P1, SFO)"
