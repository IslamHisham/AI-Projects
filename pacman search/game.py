...
class Directions:
  ...
  LEFT =       {NORTH: WEST,
                 ...
                 EAST:  NORTH,
                 WEST:  SOUTH,
                 STOP:  STOP}#if pacman is moving left then its north is the west and its south is the east and so on, here we say thet north is the direction
				 #where pacman faces.

  RIGHT =      dict([(y,x) for x, y in LEFT.items()])#opposite of left

  REVERSE = {NORTH: SOUTH,
             SOUTH: NORTH,
             EAST: WEST,
             WEST: EAST,
             STOP: STOP}#in case packman is moving to the bottom.
...
class Configuration:
  ...
  def generateSuccessor(self, vector):
    ...
    if direction == Directions.STOP:#check for obstacles
